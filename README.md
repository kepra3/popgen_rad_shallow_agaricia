...
This repository contains all scripts and datafiles required to run all analyses performed within Prata et al. (2024) Some reef-building corals disperse only metres per generation. Proceedings of the Royal Society B: Biological Sciences. 
